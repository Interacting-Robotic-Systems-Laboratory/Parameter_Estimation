function h = plot_trajectories_fixed(estimation_size,Prdiction_size,N_1,N_2,position,Brio_Data,D415_Data)
...
Brio_FW_CL_Q_p = Brio_Data.SW_CL_Q_p(:,:,position_Brio);
...
for I = 1:3
    % fixed estimation window for Brio
    subplot(3,2,2*I-1)
