...
%% load the data
data_index = '61';
data_name = strcat('D415_solution_',data_index,'.mat');
load(data_name);
T = Solution_D415.Timestamp;
q_x = Solution_D415.q_x;
q_y = Solution_D415.q_y;
theta = Solution_D415.theta;
...
flag = 2;
for i = 1:N
    S.Estimation_window = [N_1, N_2+i-1];
...
filename1 = strcat('D415_q_x_fixed_window_',data_index,'.gif'); 
filename2 = strcat('D415_q_y_fixed_window_',data_index,'.gif');
filename3 = strcat('D415_theta_fixed_window_',data_index,'.gif');

for i = 1:N
    N_2_p = N_2 + i - 1;
    %plot_denoised_data(Data);
    h1 = plot_trajectory(S,N_1,N_2_p,i,Data,1);
    h2 = plot_trajectory(S,N_1,N_2_p,i,Data,2);
    h3 = plot_trajectory(S,N_1,N_2_p,i,Data,3);
