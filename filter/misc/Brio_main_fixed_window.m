...
filename1 = strcat('Brio_q_x_fixed_window_',data_index,'.gif'); 
filename2 = strcat('Brio_q_y_fixed_window_',data_index,'.gif');
filename3 = strcat('Brio_theta_fixed_window_',data_index,'.gif');
